...
<script src="connectToFiles.js"></script>
<h1 style="text-align:center;"> Admin Login</h1>

	<form action="afterLogin.php" method="post" >
  		<div class="container" style="width: 300px; margin: 0 auto 0 auto;" >
    		<label><b>Employee ID</b></label>
    		<input type="text" placeholder="Enter Employee ID" name="edi" required>
			<br>
			<br>
