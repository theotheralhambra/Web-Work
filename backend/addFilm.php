...
<ul>
	...
	<form action="updated.php" method="POST" style="width: 500px; margin: 50px auto 0 auto;">
  		Enter id of film to be added:
   		<input type="text" name="filmID"><br>
  		Enter title of film to be added:
  		<input type="text" name="title"><br>
  		Enter picURL of film to be added:
  		<input type="text" name="picURL"><br>
  		Enter MPAA of film to be added:
		<input type="text" name="MPAA"><br>
  		Enter releaseDate of film to be added:
		<input type="text" name="releaseDate"><br>
  		Enter director of film to be added:
		<input type="text" name="director"><br>
  		Enter distributor of film to be added:
		<input type="text" name="distributor"><br>
  		Enter genre of film to be added:
		<input type="text" name="genre"><br>
  		Enter filmFormat of film to be added:
		<input type="text" name="filmFormat"><br>
  		Enter runtime of film to be added:
		<input type="text" name="runtime"><br>
  		Enter actor1 of film to be added:
		<input type="text" name="actor1"><br>
  		Enter actor2 of film to be added:
		<input type="text" name="actor2"><br>
  		Enter actor3 of film to be added:
		<input type="text" name="actor3"><br>
  		Enter info of film to be added:
